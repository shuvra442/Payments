...
public class PayUPayment {
    ...
    // In-memory map for coupon codes
    ...
    public ResponseEntity<Map<String, String>> createCheckoutSession(@RequestBody Map<String, Object> payload) {
        ...
        String phone = payload.get("phone") != null ? payload.get("phone").toString() : "0000000000";
     ...
     *
     * @param params
     * @return Success ans also save data in DB and send mail.
     */
    ...
    public ResponseEntity<String> paymentSuccess(@RequestParam Map<String, String> params) {
        try {
            ...
            if ("success".equalsIgnoreCase(status) && txnId != null) {
                ...
                newEnrollment.setDate(new Date().toString());
    ...
    public ResponseEntity<Map<String, Object>> applyCoupon(@RequestBody Map<String, String> requestBody) {
        ...
        response.put("validCoupon", COUPONS.containsKey(couponCode));
